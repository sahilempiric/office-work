...
from instagram.basebot import BaseBot
...
from instagram.dialogs import RateDialog, VpnConfirmDialog, MaximumDevicesReachedDialog
from instagram.dialogs import AuthenticationErrorDialog, NewWifiDetectedDialog
