...
class Command(BaseCommand):
        ...
        while True:
            ...
            try:
                if self.continue_process:
                    country='Hong Kong'
                    user_avd = self.avds_(country='Hong Kong')
                ...
                try:
                    ...
                    if new_user :
                        ...
                        if self.Random == False:
                            insta_random,random_action_count = True,[0,0,0,0]
                    ...
                    if self.Engagement == True:
                        ...
                        if suceess_searched_user_bool:
                            ...
                            if target_process:self.Engagement = True
                            time.sleep(10)
    ...
    def avds_(self,country='Hong Kong'):
        ports = list(
        filter(
...
# com.instagram.android:id/media_set_row_content_identifier
