                ...
                try:
                    ...
                    try:
                        ...
                        if success_updated_user_prof :
                            if not insta_random:
                                insta_random,random_action_count = tb.random_actions(new_user.username)
                                if insta_random:
                                    self.Random = False
                        ...
                        if insta_random:
                            if not follow_eachother:
                                ...
                                for follow_user in follow_user_li:
                                    for i1 in range(3):
                                        # follow_user = follow_user_li[i]
                                        if follow_user.username == new_user.username:break 
                                        ...
                                        if search_user:
                                            ...
                                            break
                                new_user.following = tb.following_counts()
                                new_user.save()
