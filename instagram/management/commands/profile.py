...
from instagram.models import Inactive_accounts_local, User,UserAvd, user_detail_local
...
class Command(BaseCommand):
    ...
    def run_tasks(self):
        ...
        # print(33)
        accounts_created = 0
        user_cred_list=list(user_detail_local.objects.filter(updated = False,status = 'ACTIVE').order_by('?'))
        # print(44)
            ...
            try:
                for i in range(3):
                    ...
                    try:
                        ...
                        if login_issue and insta_login == True:
                        ...
                        #         user_action_1 = None
                        #         try:
                        #             random_user_for_login = user_detail.objects.get(username=i_user)
                        #             LOGGER.info(random_user_for_login,3)
                        #             user_action_1 = User_action.objects.create(
                        ...
                        #         if user_action_1 != None:
                        #             try:
                        #                 random_user_for_login = user_detail.objects.get(username=i_user)
                        #                 LOGGER.info(random_user_for_login,2)
                        #                 user_action_2 = User_action.objects.create(
                        #                     user_detail = random_user_for_login,
                        ...
                        #             except Exception as e:print(e)
                            ...
                            random_user_for_login = user_detail_local.objects.get(username=i_user)
                            ...
                            if success_updated_user_prof :break
                        else:
