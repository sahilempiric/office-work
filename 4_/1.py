...
driver.get('https://www.bdsi.de/mitglieder/mitglieder-und-lieferverzeichnis/')
random_sleep(5,3)
...
data_frame = pd.DataFrame(list(zip(lead_li,title,website)),columns=['Lead Source','Title','Website'],dtype=str,index=None)
for link in links:
    try:
        driver.get(link)
        random_sleep(3,2)
        ...
        data_frame.to_csv('/media/eu4/49fa581d-6d91-4c0f-886a-2d6d1a2b9857/project/scrapping/4_/scrapped_data.csv')
